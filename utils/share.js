...
let otherShareList = [
	{
		icon: "https://api.shengqianxiong.com.cn/img/20201205/afaf7f33aaf340199b6f2a8ac9646166.png",
		text: "复制",
		provider: "copy",
		onClick: onCopy
	},
	{
		icon: "https://api.shengqianxiong.com.cn/img/20201205/04e92e33dec64a2d868abbbf9cc63ca7.png",
		text: "更多",
		provider: "more",
		onClick: onMore
	}
...
uni.getProvider({
	...
	success: function (res) {
		if (res.provider.includes('weixin')) {
			...
			{
				icon: "https://api.shengqianxiong.com.cn/img/20201205/9d2af9c71c014206848d3bb91593e37c.png",
				text: "朋友圈",
				onClick: onShare,
				provider: "weixin",
