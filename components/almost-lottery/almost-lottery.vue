	...
	<view class="almost-lottery" :style="{ width: canvasWidth + 44 + 'px', height: canvasHeight + 44 + 'px'}">
		<view class="almost-lottery-wrap" :style="{width: canvasWidth + 'px', height: canvasHeight + 'px'}">
         ...
         height: canvasHeight + 'px'
			...
			<!-- #endif -->
			<image crossorigin="anonymous" class="canvas-img" :src="lotteryImg" :style="{
         width: canvasWidth + 'px',
         height: canvasHeight + 'px',
...
<script>
	import {
		pathToBase64
	} from '@/almost-utils/image-tools.js'
	import {
		getStore,
		setStore,
		clearStore,
...
<style lang="scss" scoped>
	...
	.almost-lottery {
		...
		background-image: url(https://api.shengqianxiong.com.cn/img/20201121/4560c8df28c6409cb630e9db8b83ad67.png);

		@media (-webkit-min-device-pixel-ratio: 2), (min-device-pixel-ratio: 2) {
			background-image: url(https://api.shengqianxiong.com.cn/img/20201121/19a57704ec2c4478ad7edb1b3bc8c7af.png);
		}

		@media (-webkit-min-device-pixel-ratio: 3),
		(min-device-pixel-ratio: 3) {
			background-image: url(https://www.gomyorder.cn/img/20201118/058b4049b6d24dc29c6c813836cbcc13.png);
		}
	}
	...
	.almost-lottery__action {
		...
		background-position: center center;
		background-size: contain;
		background-image: url(https://api.shengqianxiong.com.cn/img/20201121/76010f9c9cec4630a8e301c06a8f43e5.png);

		@media (-webkit-min-device-pixel-ratio: 2), (min-device-pixel-ratio: 2) {
			background-image: url(https://api.shengqianxiong.com.cn/img/20201121/58fd7ffa03ed496e8ea1b07623d01d21.png);
		}

		@media (-webkit-min-device-pixel-ratio: 3),
		(min-device-pixel-ratio: 3) {
			background-image: url(https://www.gomyorder.cn/img/20201118/be5814283aa648ee94800df1612defaf.png);
		}
	}
